...
-(void) p_set {
    ...
    // playerTableView
    self.playerTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, CGRectGetHeight(self.mainScroll.frame)) style:(UITableViewStylePlain)];
    ...
    // eventTableView
    self.eventTableView = [[UITableView alloc] initWithFrame:CGRectMake(kScreenWidth, 0, kScreenWidth, CGRectGetHeight(self.mainScroll.frame)) style:(UITableViewStylePlain)];
    //======================
    // 背景色
